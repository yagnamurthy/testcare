...
/**
 * Finds the show of an item in the given array with the specified ID.
 *
 * @param array Array to search in.
 * @param id ID to search for.
 *
 * @return The show of the item in the array with the given ID, or -1 if the item was not found.
 */
