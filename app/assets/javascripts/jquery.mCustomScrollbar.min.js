  ...
  var b = {
    init: function (e) {
      ...
      return this.each(function () {
        ...
        if (!c(document).data("mCustomScrollbar-show")) {
          c(document).data("mCustomScrollbar-show", "1")
        } else {
          var t = parseInt(c(document).data("mCustomScrollbar-show"));
          c(document).data("mCustomScrollbar-show", t + 1)
        }
        m.wrapInner("<div class='mCustomScrollBox mCS-" + e.theme + "' id='mCSB_" + c(document).data("mCustomScrollbar-show") + "' style='position:relative; height:100%; overflow:hidden; max-width:100%;' />").addClass("mCustomScrollbar _mCS_" + c(document).data("mCustomScrollbar-show"));
        ...
        m.data({
          mCS_Init: true,
          mCustomScrollbarIndex: c(document).data("mCustomScrollbar-show"),
